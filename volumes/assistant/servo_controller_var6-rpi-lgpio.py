...
import time
import logging
import lgpio  # ← Системный lgpio (из apt), не из pip

logging.basicConfig(level=logging.INFO)
logger = logging.getLogger(__name__)

logger.info("✅ Системный lgpio доступен")
...
class ServoController:
    def __init__(self, config_path='config.yaml'):
        ...
        # Системный lgpio работает без daemon!
        ...
        logger.info(f"✅ Сервопривод SG-90 инициализирован на GPIO{self.pin} (системный lgpio)")
